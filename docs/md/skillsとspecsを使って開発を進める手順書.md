...
4. AI を起動する
5. `docs/input-specs/汎用サービス開発仕様プロンプト.md` を参考に開発要件を決める
6. `docs/input-specs/汎用サービス開発仕様プロンプト.md` を修正させる
7. 最初は実装させず、`SPEC.md` とタスク分解だけ作らせる
8. 1 タスクずつ実装させる
9. ずれたときに立て直す
...
- `C:\Users\username\work\minimal-skills-pack\specs\汎用サービス開発仕様プロンプト.md`
...
Copy-Item `
  -Path "C:\Users\username\work\minimal-skills-pack\specs\汎用サービス開発仕様プロンプト.md" `
...
cp "/c/Users/username/work/minimal-skills-pack/specs/汎用サービス開発仕様プロンプト.md" ./docs/input-specs/
```
...
1. `docs/input-specs/汎用サービス開発仕様プロンプト.md` を読む
2. その内容を参考に、今回の project の開発要件を決める
3. 決めた内容を反映して `docs/input-specs/汎用サービス開発仕様プロンプト.md` を修正する
4. 必要な skill を選ぶ
5. `SPEC.md` と `tasks/plan.md` と `tasks/todo.md` を作る
...
作業の進め方は次の条件に従ってください。
- docs/input-specs/汎用サービス開発仕様プロンプト.md を参考にして、今回の project の開発要件を決める
- 決めた開発要件を docs/input-specs/汎用サービス開発仕様プロンプト.md に反映して修正する
- 最初はいきなり実装しない
...
```text
出力してほしいもの:
- 修正後の docs/input-specs/汎用サービス開発仕様プロンプト.md
- SPEC.md
- tasks/plan.md
- tasks/todo.md
...
```text
この project では、利用可能な skills を使いながら開発を進めてください。
まず docs/input-specs/汎用サービス開発仕様プロンプト.md を読んでください。

最初にやること:
- docs/input-specs/汎用サービス開発仕様プロンプト.md を参考にして開発要件を決める
- 決めた内容で docs/input-specs/汎用サービス開発仕様プロンプト.md を修正する
- SPEC.md を作る
- tasks/plan.md を作る
- tasks/todo.md を作る
- タスクは小さく縦切りで分ける
...
- 最初に input-specs を project 向けに直す
- 最初は **計画だけ**
- 実装は **1 タスクずつ**
- 毎回 `typecheck` と `build`
